using DemoOpenTK.DisplayedObjects.Materials;
...
namespace DemoOpenTK
{
    public class BaseMaterial
    {
        ...
        public BaseMaterial(MaterialModel model)
        {
        ...
        public static BaseMaterial LoadFromJsonFile(string pathToFile)
        {
            ...
            MaterialModel model = JsonSerializer.Deserialize<MaterialModel>(fileText)
                ?? throw new SerializationException(fileText);
